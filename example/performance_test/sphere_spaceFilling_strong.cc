...
void circle_test_local(Grid &subgrid, Communicator &comm, Decomposition &subDecomposition, GlobalId &subGlobalId, SpaceFillingCurve &curve )
{
    ...
    std::vector<double> refine_time, coarse_time, repartition_time, parmetis_time, marking_time, nE_global_vec, nC_global_vec, numberIterations_refine, numberIterations_coarse;
